 ...
 * @author Hoanf
 */
public class QLPhongBanJFrame extends javax.swing.JFrame {

    /**
     * Creates new form QLPhongBanJFrame
     */
    public QLPhongBanJFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLPhongBanJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLPhongBanJFrame().setVisible(true);
            }
        });
    }
